...
type LxcInitParameters struct {
	...
	Mountpoint []MountpointInitParameters `json:"mountpoint,omitempty" tf:"mountpoint,omitempty"`
	...
	Rootfs []RootfsInitParameters `json:"rootfs,omitempty" tf:"rootfs,omitempty"`
...
type RootfsInitParameters struct {
	ACL *bool `json:"acl,omitempty" tf:"acl,omitempty"`
...
type LxcSpec struct {
	...
	// autoscaler.
	InitProvider LxcInitParameters `json:"initProvider,omitempty"`
}
...
type Lxc struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.targetNode) || (has(self.initProvider) && has(self.initProvider.targetNode))",message="spec.forProvider.targetNode is a required parameter"
